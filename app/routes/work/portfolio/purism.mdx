...
import coverImg from '~/images/portfolio/purism-cover.png';
...
<Figure
  src={coverImg}
  alt="Screenshot of the above-the-fold content of the purism home page."
  caption="The Purism home page."
/>
...
<Figure
  src={overlapImg}
  alt="Screenshot of purism home page demonstrating an unusual layout."
